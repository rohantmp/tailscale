...
func deregisterMetrics(m *metrics) {
	metricRecvDataPacketsIPv4.Deregister(m.inboundPacketsIPv4Total)
	metricRecvDataPacketsIPv6.Deregister(m.inboundPacketsIPv6Total)
	metricRecvDataPacketsDERP.Deregister(m.inboundPacketsDERPTotal)
	metricSendUDP.Deregister(m.outboundPacketsIPv4Total)
	metricSendUDP.Deregister(m.outboundPacketsIPv6Total)
}
